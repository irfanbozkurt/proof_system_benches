...
pub(crate) const fn col_input(i: usize) -> usize {
    if i < super::range_check_16::NUM_RANGE_CHECKS {
        ...
        let col_index_for_range_check_degree = i - super::range_check_16::NUM_RANGE_CHECKS;
        super::range_check_degree::col_rc_degree_input(col_index_for_range_check_degree)
    }
}
