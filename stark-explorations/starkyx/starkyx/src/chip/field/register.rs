...
mod tests {
    ...
    impl AirParameters for FpMemAddTest {
        ...
        const EXTENDED_COLUMNS: usize = 336;
    ...
    fn test_fp_memory_add() {
        ...
        let res = builder.alloc::<FieldRegister<P>>();

        builder.set_fp_div(&a_pub, &b_pub, &res);
        ...
        let generator = ArithmeticGenerator::<L>::new(trace_data, num_div);
        ...
        writer.write(
            &a_pub,
            &Polynomial::<F>::from_biguint_field(&(rng.gen_biguint(256) % &p), 16, 16),
            0,
        );
        writer.write(
            &b_pub,
        ...
        ////////
        //////// Write global and row instructions
        ////////
        ...
        let config = SC::standard_fast_config(num_div);
